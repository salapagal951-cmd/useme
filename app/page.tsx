...
<section className="grid items-center gap-16 py-10 lg:grid-cols-[1.15fr_0.85fr]">
  ...
  <div>
    ...
    <p className="mt-6 max-w-xl text-xl leading-9 text-zinc-600">
      Generate quizzes, transform PDFs, and convert study material into
  ...
  <div className="relative hidden lg:flex items-center justify-center">
    ...
    <div className="absolute h-80 w-80 rounded-full bg-blue-100 blur-[90px] opacity-70" />

    <div className="relative flex flex-col gap-6">

      {/* Card 1 */}

      <div className="ml-12 flex w-64 items-center gap-4 rounded-3xl border border-zinc-200 bg-white px-6 py-5 shadow-xl rotate-6 transition hover:-translate-y-1">
      ...
      <div className="-ml-8 flex w-64 items-center gap-4 rounded-3xl border border-zinc-200 bg-white px-6 py-5 shadow-xl -rotate-6 transition hover:translate-y-1">
